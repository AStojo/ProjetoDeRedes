...
| 14 | Cliente envia ficheiro válido               |SEND teste.txt           | 200 ficheiro recebido teste.txt X bytes        | 200 ficheiro recebido run.bat 224 bytes                                |    SIM   |
| 15 | Ficheiro guardado em uploads/               |SEND teste.txt           | ficheiro aparece em uploads/                   | O ficheiro não aparece em uma pasta separada, aparece na pasta servidor|MEIO TERMO| 
| 16 | Cliente envia ficheiro acima do limite      |SEND ficheiro_grande.zip | 400 tamanho excede limite                      | 400 tamanho excede limite. Maximo permitido: 5 MB                      |    SIM   |
| 17 | Cliente tenta path traversal                |SEND ../../x.txt         | 400 nome de ficheiro invalido                  | 400 nome de ficheiro invalido. Exemplo: SEND foto.jpg                  |    SIM   |
| 18 | Cliente envia ficheiro vazio                |SEND vazio.txt           | 400 ficheiro vazio                             | 400 ficheiro vazio. O ficheiro nao pode ter 0 bytes                    |    SIM   |
| 19 | Cliente muda o nome após login              |NICK novo_nome           | 200 nome alterado para novo_nome               | 200 nome alterado para novo_nome                                       |    SIM   |
| 20 | Outros clientes veem mudança de nome        |NICK novo_nome           | *** alice mudou o nome para novo_nome          | *** alice mudou o nome para novo_nome                                  |    SIM   |
...
| 27 | Cliente fica inativo 3 minutos              |            __           | 408 timeout                                    | 408 timeout                                                            |    SIM   |
...
| 30 | UDP Discover sem servidor                   | DISCOVER (sem servidor) | Nenhum servidor encontrado na rede             | Nenhum servidor encontrado na rede                                     |    SIM   |                        
| 31 | Cliente fecha inesperadamente               | fechar janela           | Servidor remove cliente da lista               | Servidor remove cliente da lista                                       |    SIM   |